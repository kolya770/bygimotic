...
@section('content')
    <div class="content">
        <div class="container content-width">
            <div class="row">
                <div class="col-sm-12 categories center-block my-navbar">
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1">
                            <h2>Категории товаров</h2>
                        </div>
                    </div>
                    <div class="col-sm-12 image-click">
                        <div class="col-sm-6 padding background-1">
                        ...
                        <div class="col-sm-3 padding background-1">
                        ...
                        <div class="col-sm-3 padding background-2">
